...
class VendorAccount(models.Model):
    ...
    aadhaar_card = models.CharField(max_length=30,  blank=True)
    pan = models.CharField(max_length=30,  blank=True)
    companypan = models.CharField(max_length=30,  blank=True)
    pan_image = models.ImageField(upload_to=get_uplaod_file_name,  blank=True, )
    aadhaar_image = models.ImageField(upload_to=get_uplaod_file_name,  blank=True, )
    companypan_image = models.ImageField(upload_to=get_uplaod_file_name,  blank=True, )
    ...
    is_active = models.BooleanField(default=True)
    logo = models.ImageField(upload_to=get_uplaod_file_name,  blank=True)
