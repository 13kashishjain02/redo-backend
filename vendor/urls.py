...
urlpatterns = [
    ...
    path('product/delete/<int:id>/',views.product_delete,name="delete_prouct"),
    path('product/variation/delete/<int:id>/',views.product_delete_variation,name="product_delete_variation"),
]
