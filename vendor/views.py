...
def documents(request):
    if request.user.is_authenticated and request.user.is_Vendor:
        if request.method == "POST":
            ...
            v = VendorAccount.objects.get(vendor=request.user)
            v.pan_image = pan
        ...
        if request.method == "POST":
            ...
            if category == "Choose":
                ...
                try:
                    ...
                    subcategory1 = str(sub_category1).lower(),
                    subcategory2 = str(sub_category2).lower(),
                    subcategory3 = str(sub_category3).lower(),
                    description = l_desc,
    ...
    if request.user.is_authenticated and request.user.is_Vendor and  request.user.vendoraccount.is_verified:
        if request.method == "POST":
            ...
            if category and category != 'Choose':
                v_product.category = str(category).lower()
            if sub_category1 and sub_category1 != 'Choose':
                v_product.subcategory1 = str(sub_category1).lower()
            if sub_category2 and sub_category2 != 'Choose':
                v_product.subcategory2 = str(sub_category2).lower()
            if sub_category3 and sub_category3 != 'Choose':
                v_product.subcategory3 = str(sub_category3).lower()
...
def edit_product_variation(request,id):
    ...
    if request.method == "POST":
        ...
        if category and category != 'Choose':
                p_id.category = str(category).lower()
        if sub_category1 and sub_category1 != 'Choose':
            p_id.subcategory1 = str(sub_category1).lower()
        if sub_category2 and sub_category2 != 'Choose':
            p_id.subcategory2 = str(sub_category2).lower()
        if sub_category3 and sub_category3 != 'Choose':
            p_id.subcategory3 = str(sub_category3).lower()
...
@csrf_exempt
def product_delete_variation(request,id):
